...
export const Navbar: React.FC = () => {
  ...
  return (
    <div className="fixed top-6 left-1/2 -translate-x-1/2 z-50 flex justify-center pointer-events-none">
      ...
      <motion.div 
        layout
        className="pointer-events-auto flex items-center bg-soil-950 text-cream rounded-full px-2 py-2 pr-2 shadow-2xl shadow-soil-900/30 border border-soil-800 backdrop-blur-xl gap-2 md:gap-4 overflow-hidden max-w-[calc(100vw-2rem)] md:max-w-none"
      ...
      >
        ...
        <motion.button 
          ...
          className="w-11 h-11 bg-white/5 hover:bg-white/10 border border-white/10 text-cream rounded-full flex items-center justify-center transition-all shrink-0 ml-auto"
